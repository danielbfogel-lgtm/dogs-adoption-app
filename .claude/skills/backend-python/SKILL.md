---
name: backend-python
description: Backend coding conventions for the dog-adoption platform's Python serverless functions in api/. Load whenever writing, editing, or reviewing Python backend code, Supabase data access, or the dog-to-family matching/scoring algorithm.
---
